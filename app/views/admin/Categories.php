        ...
        <div class="w-full md:w-1/2 mx-auto bg-white p-6 rounded-md shadow-md">
            ...
            <form action="../../controllers/ConCategorie.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input name="image" value="<?= $img ?>" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="Category_image" id="Category_image" type="file">
                </div>
