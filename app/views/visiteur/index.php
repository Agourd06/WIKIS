...
<body>
    <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 mb-6 md:mb-4">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="../../../public/images/logowiki.png" class="h-[60px]" alt="Agourd assurance" />
            ...
            <div class="md:flex cursor-pointer w-full md:min-h-[25vh] min-h-fit bg-slate-100 rounded-xl p-8 md:p-0  hover:scale-105 mb-6 md:mb-4">
                ...
                <div class="pt-6 md:p-8 text-center md:text-left space-y-4">
                    ...
                    <div class="font-medium text-sky-500">
                        ...
                        <p>oualid agourd</p>
                        <div class="w-full text-right font-medium text-black mt-2"> Date : 20/20/2000 15:15</div>
